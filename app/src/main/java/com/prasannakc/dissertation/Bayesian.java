...
/**
 * Created by PrasannaKC on 10/05/2015.
 */
public class Bayesian {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Connection connect = DriverManager.getConnection("jdbc:mysql://localhost/person?" +
                    "user=root&password=");
            ...
            gender = "male";
            ResultSet rs = sest
                    .executeQuery("SELECT * FROM personal where gender like '"
                            + gender + "'");
            while (rs.next()) {
            ...
            while (rs2.next()) {
                ...
                if (temp1 <= 1.61)
                    s1++;
                else if (temp1 > 1.61 && temp1 <= 1.71)
                    s2++;
                else if (temp1 > 1.71 && temp1 <= 1.81)
                    m3++;
                else if (temp1 > 1.81 && temp1 <= 1.91)
                    m4++;
                else if (temp1 > 1.91 && temp1 <= 1.96)
                    m5++;
                else if (temp1 > 1.96 && temp1 <= 2.0)
                    t5++;
                else if (temp1 > 2.0)
                    t6++;
            ...
            gender = "short";
            ResultSet rs4 = sest
                    .executeQuery("SELECT * FROM personal where class like '"
                            + gender + "'");
            while (rs4.next()) {
                pshort++;
            }
            ...
            if (egender.equals("male")) {
                ...
                if (psgivent > pmgivent && psgivent > ptagivent)
                    classn = "short";
                else if (pmgivent > psgivent && pmgivent > ptagivent)
                    classn = "medium";
                else
                    classn = "tall";
            ...
            inst.executeUpdate("insert into personal values (" + eid + ",'"
                    + name + "','" + egender + "'," + height + ",'" + classn
                    + "')");
            connect.close();
